            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2>Tìm kiếm sản phẩm với từ khóa "{{name}}"</h2>
                    </div>
                </div>
            </div>
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic  zoom"
                            ...
                            <ul class="featured__item__pic__hover">
                                ...
                                <li><a style="cursor: pointer;" @click="AddToCart(product)"><i
    ...
    methods: {
        async getAllProducts() {
            ...
            try {
                ...
                let term = this.name;
                this.products = this.products.filter(item => item.name.toLowerCase().indexOf(term.toLocaleLowerCase()) > -1);
    ...
    mounted() {
        this.$watch(
            ...
            (toParams, previousParams) => {
                this.getAllProducts(this.$route.params.name);
